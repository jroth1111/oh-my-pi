...
import {
	type AuthGatewayDispatchOptions,
...
async function handleImages(
	bootOpts: AuthGatewayDispatchOptions,
	req: Request,
	peer: string,
...
export function handleImageEdits(bootOpts: AuthGatewayDispatchOptions, req: Request, peer: string): Promise<Response> {
