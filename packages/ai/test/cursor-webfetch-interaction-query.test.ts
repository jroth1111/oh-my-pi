...
describe("Cursor interaction queries", () => {
	...
	it("does not approve an unknown variant merely because its wire bytes look like permission approval", async () => {
		// Only the verified WebFetch variant may be approved automatically.
